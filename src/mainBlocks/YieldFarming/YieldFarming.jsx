...
function YieldFarming() {
    ...
    const objCoin = [
        { id: 1, avatar: Vec234tor, name: "CAKE/WBNB", Liquidity: "$ 913 017 336", Lock: "200 000 000", ROI: "+ 2.43%", ROI2: "+ 2.43%", Rewards: "+ 2.43%", plusminus: "+ 2.43%", },
        { id: 2, avatar: sad, name: "CVP/USDT", Liquidity: "$ 513 017 336", Lock: "$ 3 017 336", ROI: "+ 2.43%", ROI2: "+ 2.43%", Rewards: "+ 2.43%", plusminus: "+ 2.43%", },
        { id: 3, avatar: av3, name: "QBT/ETH", Liquidity: "$ 513 017 336", Lock: "$ 3 017 336", ROI: "+ 2.43%", ROI2: "+ 2.43%", Rewards: "+ 2.43%", plusminus: "+ 2.43%", },
        { id: 4, avatar: av4, name: "PHA/DOT", Liquidity: "$ 513 017 336", Lock: "$ 3 017 336", ROI: "+ 2.43%", ROI2: "+ 2.43%", Rewards: "+ 2.43%", plusminus: "+ 2.43%", },
        { id: 5, avatar: av5, name: "CAKE/USDT", Liquidity: "$ 513 017 336", Lock: "$ 3 017 336", ROI: "+ 2.43%", ROI2: "+ 2.43%", Rewards: "+ 2.43%", AplusminusPR: "+ 2.43%", plusminus: "--", }
    ]
